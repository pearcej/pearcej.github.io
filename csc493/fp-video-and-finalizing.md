...
- Credits must be given on each video in a professional way.
- Your total video time should run between 8.0-12.0 minutes. (So if you do 2 videos, they need to add to less than this.) Remember that longer does not equate to better!
...
- Each video must have credits -these should include your name as well as acknowledgement of Berea College and any thanks you wish to give to anyone. Be sure to include all software and open source projects you leveraged.
...
- Please note that each video is your intellectual property, which means you can use it later and link to it from your LinkedIn page or websitea, and I hope that you are proud of it so you will do so. However, Berea’s CS department may also make a copy and post it publicly giving you credit.
